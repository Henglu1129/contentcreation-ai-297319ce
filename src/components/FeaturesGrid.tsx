  ...
  const sections = [
    {
      ...
      cards: [
        ...
        { title: "Generate Shorts", description: "From idea to viral Short in seconds: hook, script, visuals, CTA—all baked in.", hasButton: true, link: "https://mulerun.com/agents/4d9b4916-1311-4716-ba98-3bba7d803df3", imageIndex: 1 },

  ...
  const sections = [
    {
      ...
      cards: [
        { title: "Turn Idea to Visual", description: "Turn your AI draft into writing that actually sounds like you — in seconds.", hasButton: true, link: "https://mulerun.com/agents/7a3c7c0c-4778-49bd-9f87-7513c77b40e8", imageIndex: 0 },

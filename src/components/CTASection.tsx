...
const CTASection = () => {
  return (
    <section className="bg-cyan py-20 px-[120px] relative overflow-hidden">
      ...
      <div className="text-center relative z-10">
        ...
        <h2 className="font-anton text-6xl leading-[110%] text-foreground mb-6">
          <span className="bg-yellow-bright px-2">Get a Mule Run</span>
          <br />
          <span className="bg-yellow-light px-2">Your Messes</span>
        </h2>

        <button className="bg-foreground text-card px-6 py-3 rounded font-jetbrains font-bold text-sm uppercase flex items-center gap-2 mx-auto hover:bg-foreground/90 transition-colors">
          Sign Up for Free

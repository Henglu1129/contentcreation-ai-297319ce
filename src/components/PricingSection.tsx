    ...
    <section className="bg-yellow-light py-16 px-6">
      ...
      <div className="bg-[#FDFBF5] rounded-2xl p-12 max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center mb-12">
          <div className="bg-background border-t-4 border-t-lavender border border-foreground/10 rounded-lg p-6 w-full md:w-[340px]">
          ...
          <div className="bg-yellow-light border-t-4 border-t-yellow-bright border border-foreground/10 rounded-lg p-6 w-full md:w-[340px] relative">
            <span className="font-inter font-bold text-sm text-foreground block mb-4">
          ...
          <div className="bg-yellow-light border-t-4 border-t-yellow-bright border border-foreground/10 rounded-lg p-6 w-full md:w-[340px]">
            <span className="font-inter font-bold text-sm text-foreground block mb-4">
              Annual savings
            </span>
